...
module.exports = function (controller) {
    ...
    controller.hears([/^show\s*(.*)$/, /^code\s*(.*)$/], 'direct_message,direct_mention', function (bot, message) {
        ...
        bot.startConversation(message, function (err, convo) {
            ...
            convo.ask("Please choose a skill among 'favorite', 'recipe', 'storage', 'threads', 'variables', 'about', 'join', 'help'", [
                {
                    pattern: "^favorite|recipe|storage|threads|variables|about|join|help$",
